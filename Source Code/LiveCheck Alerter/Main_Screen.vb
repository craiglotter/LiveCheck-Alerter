...
Public Class Main_Screen
    ...
    Private Sub SendNotificationEmail(ByVal StartOrClose As String)
        Try
            If LCA_Emails.Text.Length > 0 Then
                StatusLabel.Text = "Sending Okay Notification"
                Dim body As String
                ...
                body = body & vbCrLf & "User Name: " + Environment.UserName
                If StartOrClose = "Startup" Then
                    TextMail("mail.uct.ac.za", "LiveCheckAlerter@uct.ac.za", LCA_Emails.Text, "LiveCheck Alerter: Successful Startup", body)
                Else
                    TextMail("mail.uct.ac.za", "LiveCheckAlerter@uct.ac.za", LCA_Emails.Text, "LiveCheck Alerter: Application Shutdown", body)
                End If
            End If
